...
<template>
  <vue-custom-scrollbar class="scroll-container p-0">
    <div class="sideBar position-relative overflow-auto">
      <el-menu default-active="2" class="el-menu-vertical-demo h-100vh overflow-auto">
        ...
        <el-menu-item index="1">
          ...
          <span slot="title"
            ><router-link class="text-dark" to="./home">Home</router-link></span
          >
        </el-menu-item>
        <el-menu-item index="2">
          <i class="el-icon-medal"></i>
          <span slot="title"
            ><router-link class="text-dark" to="./certificate"
        ...
        <el-menu-item index="3">
          ...
          <span slot="title"
            ><router-link class="text-dark" to="./setting">Settings</router-link></span
          >
        </el-menu-item>
        <el-menu-item index="4">
          <i class="el-icon-time"></i>
          <span slot="title"
            ><router-link class="text-dark" to="./logs">Logs</router-link></span
          >
        </el-menu-item>
        <el-menu-item index="5">
          <i class="el-icon-document"></i>
          <span slot="title"
            ><router-link class="text-dark" to="./term-and-condition"
        ...
        <el-menu-item index="7">
          ...
          <span slot="title"
            ><router-link class="text-dark" to="./about-us">About Us</router-link></span
          >
        </el-menu-item>
        <el-menu-item index="8">
          <i class="el-icon-phone-outline"></i>
          <span slot="title"
            ><router-link class="text-dark" to="./contact-us"
        ...
        <el-menu-item index="9">
          ...
          <span slot="title"
            ><router-link class="text-dark" to="./faqs">FAQs</router-link></span
          >
        </el-menu-item>
