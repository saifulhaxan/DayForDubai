  ...
  <div class="eventDetailSecion">
      ...
      >
        ...
        >
          <div class="upComingBox">
            <p class="mb-0 text-theme-primary font-weight-600">{{estatus}}</p>
          </div>
        </div>
      </div>
    </div>
    <div class="eventDetail px-3 shadow">
        ...
        <div class="editOption pr-3">
          <el-dropdown trigger="click">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item icon="el-icon-edit-outline" v-if="buttonText">
                <span @click="editOptions = true"> Edit</span></el-dropdown-item
              >
              <el-dropdown-item icon="el-icon-edit-outline" v-if="!buttonText">
                <span @click="reviewBox = true"> Rate & Review</span></el-dropdown-item
              >
              <el-dropdown-item icon="el-icon-delete">
                <span @click="suggestionBox = true">Report</span></el-dropdown-item
              >
            </el-dropdown-menu>
          </el-dropdown>
          <el-dialog
          ...
          >
            <div class="popup-content-box">
              ...
              <div class="reviewBox">
                <div class="ratingBox mb-3"><el-rate v-model="ratingStar"></el-rate></div>
                <el-form action="">
                  <el-form-item class="textareaStyle">
                    <el-input
                      type="textarea"
      ...
      <div class="d-flex justify-content-between align-items-center flex-wrap">
        ...
        <div class="mapBox">
          <p class="mb-0">
            <a href="#" class="text-theme-primary font-weight-600">View On Map</a>
          </p>
        </div>
      </div>
      ...
      <div class="tabspost mt-4">
        <el-tabs type="card" @tab-click="handleClick">
          <el-tab-pane label="Post">
            <searhBox v-if="$route.path != '/event-page-ended'"/>
            <postTab />
          </el-tab-pane>
          <el-tab-pane label="Comments">
            <comments />
          </el-tab-pane>
          <el-tab-pane label="Reviews" v-if="!buttonText">
            <div class="d-flex w-100 px-3 flex-column my-4">
              <div class="commentitem d-flex w-100 align-items-center gap-15 justify-content-between flex-wrap">
                <div class="reviewImage order-1">
                  <img src="img/theme/v8.png" alt="" class="mw-100 w-70px" />
                </div>
                <div class="commentbox col-md-9 shadow p-3 rounded-15 order-3 order-md-2">
                  <p class="mb-0">
                    or randomised words which don't look even slightly believable. If you
                    are going to use a passage of Lorem Ipsum, Contrary to popular belief,
                ...
                <div class="rateStars order-md-3 order-2">
                     <el-rate v-model="ratingStar"></el-rate>
                </div>
              </div>
            </div>
          </el-tab-pane>
