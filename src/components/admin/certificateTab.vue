<template>
  <div class="commet certificateTem">
    <div class="approveBtn d-flex justify-content-end gap-15 py-4">
      <p class="mb-0">
        <a
          class="btn-round btn-theme-primary px-5 text-white"
    ...
    <div class="d-flex w-100 px-3 flex-column">
            ...
            <div class="approveBtn d-flex align-items-center gap-15">
              <p class="mb-0">
                <a
                  ...
                  class="w-custom btn-round btn-theme-primary px-5"
                  :class="item.btntxt == 'Awarded' ? '' : 'bg-secondary text-dark'"
                  >{{ item.btntxt }}</a
                >
              </p>
            </div>
      ...
      <div class="buttonBox text-center my-5">
        <p>
          <a href="" class="btn-theme-primary btn-round border-0 mr-2 px-4">View More</a>
        </p>
      </div>
    </div>
    <el-dialog
