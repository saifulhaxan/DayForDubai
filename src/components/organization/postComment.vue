  ...
  <div class="commet">
    <div class="d-flex justify-content-between">
      <div class="commenTitle">
        <h4 class="font-weight-600">Comments</h4>
      </div>
    ...
    <div class="d-flex w-100 px-3 flex-column">
      ...
      >
        ...
        <!-- <button type="button" @click="delBtn(index)">Remove</button> -->
      </div>
    </div>
    <div class="d-flex align-items-center gap-15 px-4 rounded-15 border-shadow py-2 my-3" v-if="!buttonText">
