    ...
    <div class="eventDetail px-3 shadow">
      ...
      <div class="contentInfo border-top py-3 mt-3">
        ...
        <div class="d-flex volunteerIcons align-items-center flex-column flex-md-row">
          ...
          <h3 class="text-light font-weight-500 ml-0 ml-md-5">+320 Following</h3>
        </div>
        ...
        <el-tabs type="card" @tab-click="handleClick" v-model="activeName">
          ...
          <!-- <el-tab-pane label="Post Requests" v-if="!buttonText">
            <div class="d-flex w-100 px-3 flex-column my-4">
              <div class="commentitem d-flex w-100 align-items-start gap-15 justify-content-between">
                <img src="img/theme/v8.png" alt="" class="mw-100 w-70px" />
                <div class="commentbox w-75 shadow p-3 rounded-15">
                  <p class="mb-0">
          ...
          <el-tab-pane label="Comments">
            ...
            <div class="postBtn text-center my-4">
              <p class="mb-0">
                <a href="" class="btn-round btn-theme-primary px-5">View More</a>
              </p>
            </div>
          </el-tab-pane>
        </el-tabs>
