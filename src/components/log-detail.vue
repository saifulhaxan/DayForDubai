  ...
  <div class="eventDetailSecion">
    ...
    <div class="eventDetail px-3 shadow">
      ...
      <div class="attendance">
          <h3 class="font-weight-900">Your Attendence</h3>
        <div class="d-flex justify-content-between border-bottom py-3 mt-3 flex-wrap flex-sm-nowrap">
            <div class="w-100 d-flex">
                <p class="mb-0"><i class="fa fa-calendar text-theme-primary pr-3"></i></p>
                <p class="text-light mb-0 font-weight-600">October 15, 2021 <span class="d-md-block">Monday</span></p>
            </div>
            <div class="d-flex w-100 gap-15 mt-3 mt-md-0">
                <div class="checkIn">
                    <h5 class="text-black font-weight-900">Check In</h5>
                    <p class="text-light font-weight-600">09:00am <span class="d-block">Total Hours:</span></p>
                </div>
                <div class="checkIn">
                    <h5 class="text-black font-weight-900">Check Out</h5>
                    <p class="text-light font-weight-600">09:00am <span class="d-block">Total Hours:</span></p>
                </div>
            </div>
        </div>
        <div class="d-flex justify-content-between py-3 flex-wrap flex-sm-nowrap">
            <div class="w-100 d-flex">
                <p class="mb-0"><i class="fa fa-calendar text-theme-primary pr-3"></i></p>
                <p class="text-light mb-0 font-weight-600">October 15, 2021 <span class="d-md-block">Tuesday</span></p>
            </div>
            <div class="d-flex w-100 gap-15 mt-3 mt-md-0">
                <div class="checkIn">
                    <p class="text-light font-weight-600">09:00am <span class="d-block">Total Hours:</span></p>
